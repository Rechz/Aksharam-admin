  ...
  <v-stepper v-model="step" :items="items" hide-actions elevation="0" flat>
    ...
    <template v-else>
      <div style="height: 50vh;" class="my-5 d-flex flex-column justify-content-center align-items-center">
        ...
        <v-btn color="green" class="mb-3" @click="addNewSub" prepend-icon="mdi-step-backward" variant="outlined">Back to
          add new main Subheadings</v-btn>
  ...
  computed: {
    ...
    methods: {
      ...
      finish() {
        ...
        this.$store.commit('display/setSubid2mal', '');
        this.$store.commit('display/setSubid2eng', '');
        this.subhead = false;
