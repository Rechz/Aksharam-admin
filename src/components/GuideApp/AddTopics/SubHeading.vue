  ...
  <v-stepper v-model="step" :items="items" hide-actions elevation="0" flat>
    <template v-if="step === 1">
      ...
      <v-form class="pt-0" ref="form" @submit.prevent="submitHeading">
        <div class="d-flex">
          <div>
            <v-select class="select" label='Select Language' density="comfortable" :items="languages" v-model="language"
          ...
          <div class="d-flex flex-column ">
            <p class="text-success text-end fst-italic mb-0" v-if="malSubmit">
              *{{ malSubHeading }} (Malayalam) subtopic added.
            </p>
            <p class="text-success text-end fst-italic mb-0" v-if="engSubmit">
              *{{ engSubHeading }} (English) subtopic added.
            </p>
          </div>
        </div>
        <div class="d-flex justify-content-between  gap-2">
          <div class="d-flex gap-2">
            <v-btn v-if="QRLoad" color="#386568" size="large" class="text-capitalize" type="submit" :disabled="subload"
              variant="elevated" rounded :loading="subload">Add {{ topic }} sub topic
            </v-btn>
    ...
    <template v-else-if="step === 2">
      <h6 class="text-center mt-4 fw-bolder ">Subheading Images</h6>
      <v-card flat>
    ...
    <template v-else-if="step === 3">
      <div class="my-3">
        <h6 class="text-center mt-4 fw-bolder ">SubHeading Audio/Video</h6>
        <div class="my-3">
          ...
          <div class="d-flex flex-column gap-2">
            <v-card class="p-3 d-flex gap-2" flat :disabled="audioMalSubmit && audioEngSubmit">
              <div>
                ...
                <v-btn @click="submitAudio(fileType.audio)" color="#386568" size="large" variant="elevated" rounded
                  prepend-icon="mdi-music" class="text-capitalize" :disabled="audioLoad" :loading="audioLoad">Submit
                  Audio</v-btn>
              </div>
              <div class="d-flex flex-column align-items-end justify-content-center ">
            ...
            <v-card class="p-3 d-flex gap-2" flat :disabled="videoMalSubmit && videoEngSubmit">
              <div>
                ...
                <v-btn @click="submitVideo(fileType.video)" color="#386568" size="large" variant="elevated" rounded
                  prepend-icon="mdi-video" class="text-capitalize" :disabled="videoLoad" :loading="videoLoad">Submit
                  Video</v-btn>
              </div>
              <div class="d-flex flex-column align-items-end justify-content-center ">
