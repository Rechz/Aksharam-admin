...
export default {
   ...
   data() {
    ...
    methods: {
        ...
        async addImage(event) {
            ...
            try {
                ...
                if (this.main == true) {
                    ...
                    response = await axios.post(`${this.base_url}/imgData/uploadImg?englishUId=${this.engId}&malUid=${this.malId}`, formData);
                }
                if (this.main == false) {
                    this.imagesAdd.forEach((image) => {
        ...
        async addVideo(event) {
            ...
            try {
                ...
                let response;
                if (this.main == true) {
                    response = await axios.post(`${this.base_url}/mediaData/mpData?uId=${this.uId}&mtId=${this.media.video}`, formData); 
                }
                if (this.main == false) {
        ...
        async addAudio(event) {
            ...
            try {
                ...
                let response;
                if (this.main == true) {
                    response = await axios.post(`${this.base_url}/mediaData/mpData?uId=${this.uId}&mtId=${this.media.audio}`, formData);
                }
                if (this.main == false) {
        ...
        async deleteImage(id) {
            ...
            try {
                if (this.main == true) {
                    response = await axios.delete(`${this.base_url}/deleteMain/deleteImages?commonId=${this.editImages[0].commonId}&imgIds=${id}`);
                }
                if (this.main == false) {
    ...
    // mounted() {
    //     if (this.main == true) {
    //         console.log('main', this.malId)
    //         console.log('main', this.engId)
    //     }
    //     else {
    //         console.log('sub', this.malId)
    //         console.log('sub', this.engId)
    //     }
