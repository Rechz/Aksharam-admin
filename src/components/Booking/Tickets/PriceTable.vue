<template>
    <v-container class="pb-0 pt-0 px-0" fluid>
        ...
        <v-data-table :headers="headers" :items="items" items-per-page="10" color="grey-darken-3" density="compact"
            :pagination="false" :header-props="{ style: 'background-color: #216D17; color: #ffffff;' }">
            <template v-slot:top>
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { title: 'Type', align: 'center', sortable: false, key: 'typeName' },
