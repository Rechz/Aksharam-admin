export default {
    ...
    setCommonIdMain(state, payload) {
        ...
        sessionStorage.setItem('commonIdMain', payload);
    },
    setCommonIdSub(state, payload) {
        state.commonIdSub = payload;
        sessionStorage.setItem('commonIdSub', payload);
    },
    setCommonIdSub2(state, payload) {
        state.commonIdSub2 = payload;
        sessionStorage.setItem('commonIdSub2', payload);
    },
